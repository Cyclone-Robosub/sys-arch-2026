...
// C/C++ source code generated on : Sat Jul 11 23:06:33 2026
//
...
class joystick_enabled_matlab_node;
...
namespace matlab {
  ...
  class NodeInterface {
    ...
    std::shared_ptr<joystick_enabled_matlab_node> mModel;
  ...
  public:
    ...
    //
    std::shared_ptr<joystick_enabled_matlab_node> getModel() {
      return mModel;
    }
  }; //class NodeInterface
  //
