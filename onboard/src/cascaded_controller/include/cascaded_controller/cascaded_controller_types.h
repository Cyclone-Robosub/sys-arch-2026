...
//
// File: cascaded_controller_types.h
//
...
//
#ifndef cascaded_controller_types_h_
#define cascaded_controller_types_h_
#include "rtwtypes.h"
...
// Custom Type definition for MATLAB Function: '<S14>/commandExecuter'
#ifndef struct_cell_wrap_1_cascaded_controll_T
#define struct_cell_wrap_1_cascaded_controll_T

struct cell_wrap_1_cascaded_controll_T
{
  char_T f1[16];
};

#endif                                // struct_cell_wrap_1_cascaded_controll_T

// Forward declaration for rtModel
typedef struct tag_RTM_cascaded_controller_T RT_MODEL_cascaded_controller_T;

#endif                                 // cascaded_controller_types_h_
