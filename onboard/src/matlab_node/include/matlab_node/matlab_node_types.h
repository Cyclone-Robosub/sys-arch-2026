...
//
#ifndef matlab_node_types_h_
#define matlab_node_types_h_
#include "rtwtypes.h"
...
// Custom Type definition for MATLABSystem: '<S210>/SinkBlock'
...
// Custom Type definition for MATLAB Function: '<S18>/commandExecuter'
#ifndef struct_cell_wrap_1_matlab_node_T
#define struct_cell_wrap_1_matlab_node_T

struct cell_wrap_1_matlab_node_T
{
  char_T f1[16];
};

#endif                                 // struct_cell_wrap_1_matlab_node_T

// Forward declaration for rtModel
typedef struct tag_RTM_matlab_node_T RT_MODEL_matlab_node_T;

#endif                                 // matlab_node_types_h_
