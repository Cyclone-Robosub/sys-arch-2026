...
//
// File: Mission_Manager_CGN_types.h
//
...
//
#ifndef Mission_Manager_CGN_types_h_
#define Mission_Manager_CGN_types_h_
#include "rtwtypes.h"
...
// Custom Type definition for MATLABSystem: '<S208>/SinkBlock'
...
// Custom Type definition for MATLAB Function: '<S19>/commandExecuter'
#ifndef struct_cell_wrap_1_Mission_Manager_C_T
#define struct_cell_wrap_1_Mission_Manager_C_T

struct cell_wrap_1_Mission_Manager_C_T
{
  char_T f1[16];
};

#endif                                // struct_cell_wrap_1_Mission_Manager_C_T

// Forward declaration for rtModel
typedef struct tag_RTM_Mission_Manager_CGN_T RT_MODEL_Mission_Manager_CGN_T;

#endif                                 // Mission_Manager_CGN_types_h_
