...
# --- MicroROS Agent ---
tmux split-window -v -t $THRUST_INTERFACE_PANE "LD_LIBRARY_PATH=/opt/ros/jazzy-agent/lib:$LD_LIBRARY_PATH ros2 run micro_ros_agent micro_ros_agent serial --dev /dev/serial/by-id/usb-Silicon_Labs_CP2102N_USB_to_UART_Bridge_Controller_3a6f6fcb5c2def119ff757c1eb7b7d6d-if00-port0 -b 921600 -D -R; bash"
